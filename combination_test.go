...
func TestCombineMurphyAverage(t *testing.T) {
	const tolerance = 0.0025
	...
	tcs := []struct {
	...
	}{
		{
			...
			expectedMfn: func() *MassFunction {
				cf := &MassFunction{}
				cf.Set(K(), 0.0)
				cf.Set(K("red"), 0.31973)
				cf.Set(K("yellow"), 0.35711)
				cf.Set(K("green"), 0.19144)
				cf.Set(K("red", "yellow"), 0.03159)
				cf.Set(K("red", "green"), 0.02035)
				cf.Set(K("yellow", "green"), 0.01677)
				cf.Set(K("red", "yellow", "green"), 0.06309)
				return cf
			},
		},
		{
			...
			expectedMfn: func() *MassFunction {
				cf := &MassFunction{}
				cf.Set(K(), 0.0)
				cf.Set(K("allow"), 0.29469)
				cf.Set(K("deny"), 0.16062)
				cf.Set(K("allow", "deny"), 0.54469)
				return cf
			},
		},
		{
...
func BenchmarkCombineMurphyAverage(b *testing.B) {
	mf1 := &MassFunction{}
	mf1.Set(K(), 0.0)
	mf1.Set(K("a"), 0.30)
	mf1.Set(K("b"), 0.20)
